...
> bash example - [script](https://github.com/hp7270/mongodb-sample-dataset/blob/main/script.sh) to import the JSON to respective db 
> widnows batch file [script](https://github.com/hp7270/mongodb-sample-dataset/blob/main/sample_airbnb/script.bat) to import the JSON to respective db, added in respective folder
